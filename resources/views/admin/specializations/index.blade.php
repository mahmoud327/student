        ...
        <div class="card mg-b-20">
            <div class="card-header pb-0">
                ...
                <a class="modal-effect btn btn-outline-primary" data-effect="effect-scale" data-toggle="modal"
                    href="#modaldemo8">Add Specialization</a>
                    ...
                    <table id="example1" class="table key-buttons text-md-nowrap" data-page-length='50'
                        ...
                        <tbody class="tr">
                            @foreach ($categories as $service)
                                ...
                                @include('admin.specializations.delete_modal', ['service' => $service])
                                @include('admin.specializations.edit_modal', ['service' => $service])
                            @endforeach
                        </tbody>
                    </table>
                </div>
