        ...
        <div class="card mg-b-20">
            <div class="card-header pb-0">
                ...
                <a class="modal-effect btn btn-outline-primary" data-effect="effect-scale" data-toggle="modal"
                    ...
                    @include('admin.categories.subServices.add_modal',['parent_id'=>$parent_id])
                    ...
                    <table id="example1" class="table key-buttons text-md-nowrap" data-page-length='50'
                        ...
                        <tbody class="tr">
                            @foreach ($services as $service)
                                ...
                                @include('admin.categories.subServices.delete_modal', ['service' => $service])
                                @include('admin.categories.edit_modal', ['service' => $service])
                            @endforeach
                        </tbody>
                    </table>
                </div>
